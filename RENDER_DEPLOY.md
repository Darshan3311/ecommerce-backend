...
1. **Create New Web Service**
   ...
   - Connect your GitHub repository: `Darshan3311/ecommerce-backend`
...
3. **Add Environment Variables**
   ...
   **REQUIRED Variables (must be added):**
   ...
   **AUTO-GENERATED by Render (click "Generate" button):**
   ```
   ...
   **OPTIONAL Variables (for email/payment features):**
   
   ```
   EMAIL_HOST=smtp.gmail.com
   EMAIL_PORT=587
   EMAIL_USER=work.darshhhuuuuu@gmail.com
   EMAIL_PASSWORD=tzyu zlua eptx yrjy
